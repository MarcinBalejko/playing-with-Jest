...
// // Less than and greater than              FAILING
...
// test('There is no I in team', () => {    FAILING
...
test('User fetched name should be Leanne Graham', () => {
    expect.assertions(1); // making sure that promise gets called
